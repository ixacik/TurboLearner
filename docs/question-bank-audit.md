...
- PASS: Question count — 28/28
- PASS: Missing numbers — none
...
- PASS: No image for text/code question 18a — none
- PASS: No image for text/code question 18b — none
- PASS: No image for text/code question 18c — none
- PASS: No image for text/code question 18d — none
- PASS: No image for text/code question 19a — none
- PASS: No image for text/code question 19b — none
- PASS: No image for text/code question 19c — none
- PASS: No image for text/code question 19d — none

Notes:

- Lettered questions without a shared group: none
- Questions with placeholder text: none
- Single-answer questions with non-4 option counts: 18a(2), 18c(2)
